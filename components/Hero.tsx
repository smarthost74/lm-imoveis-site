...
/**
 * Hero reutilizado em home, página de bairro e de condomínio — muda a
 * imagem, o texto e opcionalmente o conteúdo sobreposto (a busca, na
 * home). Fotografia própria (HDR), nunca banco de imagens.
 */
